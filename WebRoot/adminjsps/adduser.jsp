						...
						<form onsubmit="return judge()"
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="input-xlarge" id="gusername" maxlength="10"
											name="gusername" /><span id="egname"></span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="input-xlarge" id="gmail"
											name="gmail" /><span id="egemail"></span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="input-xlarge" id="gtel" name="gtel" /><span
											id="egphone"></span>
											<span id='tel_error' class='error'>电话号码格式不正确!</span>
									</div>
								</div>
								<!-- <div class="control-group">有必要分男女吗？先去了
								<label class="control-label">性别</label>
								<div class="controls">
									<input type="radio" name="gsex" id="gsex" class="input-xlarge"
										checked=checked value="男" />男 <input type="radio" name="gsex"
										id="gsex" class="input-xlarge" style="margin-left: 40px"
										value="女" />女
								</div>
							</div> -->
								<div class="control-group">
								...
								<div class="form-actions">
									<input type="submit" class="btn btn-success btn-large" id="send_message"
										value="Save User" /> <a class="btn"
