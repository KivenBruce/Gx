...
(function (global) {
            ...
            if (factoryReady) {
                try {
                    ...
                    if (/^\[MODULE_MISS\]"([^"]+)/.test(ex.message)) {
                        ...
                        // 濡傛灉鏄ā鍧楁湰韬湁闂瀵艰嚧鐨勮繍琛岄敊璇�
                        // 灏变笉瑕佹妸invoking缃洖鍘讳簡锛岄伩鍏嶅奖鍝峚utoInvoke鍏朵粬妯″潡鐨勫垵濮嬪寲
                        invoking = 0;
                        return;
                    }
    ...
    /**
     * 寮傛鍔犺浇妯″潡
     * 鍐呴儴浣跨敤锛屾ā鍧桰D蹇呴』鏄粡杩噉ormalize鐨凾op-Level ID
     *
     * @inner
     * @param {Array} ids 妯″潡鍚嶇О鎴栨ā鍧楀悕绉板垪琛�
    ...
    function loadModule(moduleId) {
        ...
        // shim渚濊禆鐨勬ā鍧楅渶瑕佽嚜鍔ㄦ爣璇嗕负shim
        // 鏃犺鏄函姝ｇ殑shim妯″潡杩樻槸hybird妯″潡
            ...
            if (typeof requireId === 'string') {
                ...
                nativeAsyncRequire(
                    ...
                    function () {
                        ...
                        // modAutoDefine涓紝factory invoke鍙兘鍙戠敓閿欒
                        // 浠庤€屽鑷磏ativeAsyncRequire娌℃湁琚皟鐢紝callback娌℃寕涓�
                        // 鎵€浠ativeAsyncRequire瑕佸厛杩愯
    ...
    /**
     * 瀵筰d杩涜package瑙ｆ瀽
     * 濡傛灉鏄痯ackage锛屽垯闄勫姞涓绘ā鍧梚d
     *
     * @inner
     * @param {string} id 妯″潡id
     * @return {string} 瑙ｆ瀽鍚庣殑id
     */
